...
入力された商品情報をもとに、上記の考え方を踏まえて、「この商品にとっての発見層はどこか」「その発見層に届く言葉・媒体・インフルエンサー構成は何か」を、編集者としての目利きで設計してください。一般論的なマーケティング用語(F1層、Z世代、など)だけに頼らず、具体的なクラスタ像を必ず一つは名指ししてください。
